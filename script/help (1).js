...
module.exports.run = async function({
  ...
  try {
    ...
    if (!input) {
      ...
      let end = start + pages;
      let helpMessage = `🜋𝐆𝐀𝐁𝐑𝐈𝐄𝐋 𝐂𝐎𝐌𝐏𝐈𝐎𝐓\n\n \n●═════❍═════●\n`;
      ...
      helpMessage += `\n▪[📚]𝗣𝗔𝗚𝗘 : [${page}/${Math.ceil(commands.length / pages)}]    \n●══════❍══════●\n[🆔]𝗔𝗨𝗧𝗢𝗕𝗢𝗧 𝗖𝗥𝗘𝗔𝗧𝗘𝗗 𝗕𝗬 : 𝐎𝐋𝐈𝐕𝐄𝐑/𝐆𝐀𝐁𝐑𝐈𝐄𝐋🏅\n[🗝️]▪𝗟𝗜𝗡𝗞-𝗙𝗕 :https://www.facebook.com/profile.php?id=61555963733226\nhttps://www.facebook.com/profile.php?id=100095725560244\n[⚙️]𝗟𝗜𝗡𝗞 𝗔𝗨𝗧𝗢𝗕𝗢𝗧 :https://gabriel-compilot.vercel.app/ `;
      api.sendMessage(helpMessage, event.threadID, event.messageID);
    } else {
